...
function formatEvent() {
  ...
  var title = attributes.title,
    ...
    appleStructuredLocation = attributes.appleStructuredLocation,
  ...
  icsFormat += appleStructuredLocation ? (0, _utils.foldLine)("X-APPLE-STRUCTURED-LOCATION;VALUE=URI;X-ADDRESS=".concat((0, _encodeNewLines["default"])((0, _utils.setLocation)(location)), ";").concat((0, _encodeNewLines["default"])((0, _utils.setAppleStructuredLocation)(appleStructuredLocation)), ":geo:").concat(geo.lat, ",").concat(geo.lon)) + '\r\n' : '';
