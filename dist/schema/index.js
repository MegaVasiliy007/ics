...
var eventShape = {
  ...
  location: yup.string(),
  appleStructuredLocation: yup.object().shape({
    title: yup.string(),
    radius: yup.number()
  }),
...
var headerAndEventSchema = yup.object().shape(_objectSpread(_objectSpread({}, headerShape), eventShape)).test('appleStructuredLocation', 'For appleStructuredLocation needs geo and location fields', function (val) {
